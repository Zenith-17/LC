            ...
            <main className='flex flex-col items-center justify-center w-full felx-1 px-20 text-center'>
                <div className='bg-white rounded-2xl shadow-2xl flex flex-row w-2/3 max-w-4xl'>
                      ...
                      <div className='w-2/5 bg-green-500 text-white rounded-tl-2xl rounded-bl-2xl py-36 px-12'>
                        ...
                        <p className='mb-10'>Lets start coding.</p>
                        <a href="#" className='border-2 border-white rounded-3xl px-12 py-2 inline-block font-semibold hover:bg-white hover:text-green-500'>Sign In</a>
                    </div>
                    {/* Signup section */}
                    <div className='w-3/5 p-5'>
                        ...
                        <div className='py-10'>
                            ...
                            <a href="/signin" className='border-2 border-green-500 text-green-500 rounded-3xl px-12 py-2 inline-block font-semibold hover:bg-green-500 hover:text-white'>Sign Up</a>
                            </div>
                        </div>
                    </div>
